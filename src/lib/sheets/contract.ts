export const SHEET_HEADERS = {
  grupos: [
    ...
    "link_formulario_ata", "ultima_reuniao_anterior", "created_at", "updated_at",
  ],
  usuarios_grupo: [
  ...
  atas: [
    "ata_id", "grupo_id", "data_reuniao", "hora_inicio", "duracao", "formato_outros", "preenchido_por", "plataforma", "tipo_reuniao",
  ...
  servidores: ["servidor_id", "ata_id", "nome", "funcao", "ordem", "created_at", "updated_at"],
